...
public class DummyModel {
	...
	public DummyModel(int id, String testUsername, String testPassword, int testAge, double testWeight) {
		super();
		this.id = id;
	...
	public DummyModel(String testUsername, String testPassword, int testAge, double testWeight) {
		super();
		this.testUsername = testUsername;
		this.testPassword = testPassword;
		this.testAge = testAge;
